...
public class SkillTemplate : ScriptableObject {
    ...
    public string Tooltip(bool showRequirements = false) {
        ...
        // cast time
        tip += "Cast Time: " + Utils.PrettyTime(castTime) + "\n";

        // cooldown
        tip += "Cooldown: " + Utils.PrettyTime(cooldown) + "\n";
        ...
        // buff
        if (buffTime > 0) tip += "Buff Time: " + Utils.PrettyTime(buffTime) + "\n";
        ...
        if (buffsHpPercentPerSecond > 0) tip += "Buffs Health % per Second: " + buffsHpPercentPerSecond + "\n";
        if (buffsMpPercentPerSecond > 0) tip += "Buffs Mana % per Second: " + buffsMpPercentPerSecond + "\n";
